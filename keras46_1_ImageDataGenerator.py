...
train_datagen=ImageDataGenerator(
    ...
    fill_mode='nearest'     #회전,축소 등으로 생긴 여백 채우기
)                           #여기까지 다 넣어도 랜덤으로 선택되서 조정됨 
#                           / 안넣으면 수치화로만 가져옴
...
xy_train=train_datagen.flow_from_directory(
    ...
    batch_size=5,           #이미지를 나눌 사이즈 (160장을 5장씩 나누자 = 32묶음)
...
# print(xy_train[0]) # y=[0., 0., 1., 1., 1.] <-배치가 5였으니까 5개 나오지요!
...
print(xy_train[31][0].shape,xy_train[31][1].shape) #(5, 150, 150, 1) (5,)
#              ㄴx                   ㄴy             ㄴbatch, target_size, target_size, color
print(type(xy_train))
