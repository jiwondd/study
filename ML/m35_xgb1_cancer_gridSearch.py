...
prameters={'n_estimator':[100,200,300,400,50,1000],
           'learnig_rate':[0.1,0.2,0.3,0.5,1,0.01,0.001],
           'max_depth':[None,2,3,4,5,6,7,8,9,10],
           'gamma':[0,1,2,3,4,5,10,100],
           'min_child_weight':[0,0.01,0.001,0.1,0.5,1,5,10,100],
           'subsample':[0,0.1,0.2,0.3,0.5,0.6,0.7,1],
           'colsample_bytree':[0,0.1,0.2,0.3,0.5,0.6,0.7,1],
           'colsample_bylevel':[0,0.1,0.2,0.3,0.5,0.6,0.7,1],
           'colsample_bynod':[0,0.1,0.2,0.3,0.5,0.6,0.7,1],
           'reg_alpha':[0.1,0,0.001,0.3,1,2,10],
           'reg_lambda':[0.1,0,0.001,0.3,1,2,10]
           }

prameters={'n_estimators':[100,200,300,400],
           'learning_rate':[0.1,0.2,0.3,0.01,0.001],
           'max_depth':[None,2,3,4,5,6],
           'gamma':[0,1,2,3,4,5],
           'min_child_weight':[0,0.01,0.001,0.1,0.5,1],
           'subsample':[0,0.1,0.2,0.3,0.5,1],
           'colsample_bytree':[0,0.1,0.2,0.3,0.5,1],
           'colsample_bylevel':[0,0.1,0.2,0.3,0.5,1],
           'colsample_bynod':[0,0.1,0.2,0.3,0.5,1],
           'reg_alpha':[0.1,0,0.3,1,2],
           'reg_lambda':[0.1,0,0.3,1,2]
           }
