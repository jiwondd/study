...
w2=tf.compat.v1.Variable(tf.random_normal([20,5]))
b2=tf.Variable(tf.random.normal([5]), name='bias') #노드가 20 / 열과 동일하게 행렬곱시켜줘야한다
hidden_layer2=tf.matmul(hidden_layer1,w2)+b2

# output
w3=tf.compat.v1.Variable(tf.random_normal([5,1]))
b3=tf.Variable(tf.random.normal([1]), name='bias2') 
...
# r2: 4.1723123089809633e-07
# acc: 0.5
# mae: 0.49999989569187164