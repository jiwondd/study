...
print(xy_dataset) # Found 2520 images belonging to 3 classes.

print(xy_dataset[10][0].shape,xy_dataset[0][1].shape) #(20, 200, 200, 3) (20, 3)

np.save('d:/study_data/_save/_npy/keras47_3_train_x.npy',arr=xy_dataset[0][0])
np.save('d:/study_data/_save/_npy/keras47_3_train_y.npy',arr=xy_dataset[0][1])
