...
star_time=time.time()
hist=model.fit(xy_train[0][0],xy_train[0][1],epochs=100,steps_per_epoch=32,
          validation_data=xy_test,validation_steps=4) #배치를 최대로 잡으면 이렇게도 가능하다
...
# loss: 1.072302211468923e-06
# val_loss: 1323.2421875
# accuracy: 1.0
# val_accuracy: 0.5166666507720947
# 걸린시간: 32.478270292282104
