...
x_train = x_train.reshape(8708,15,1)
x_test = x_test.reshape(2178,15,1)

#2. 모델구성
model=Sequential()
model.add(Conv1D(10,2,input_shape=(15,1)))
model.add(Flatten())
...
loss : 9087.4609375
r2스코어 : 0.724680247476474 <-LSTM

loss : 4749.3369140625
r2스코어 : 0.8561109320163266 <-Conv1D
'''
