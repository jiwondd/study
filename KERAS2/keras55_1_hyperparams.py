...
# 걸린시간 :  28.322428941726685
# model.best_params_ :  {'optimizer': 'rmsprop', 'drop': 0.4, 'batch_size': 100, 'activation': 'sigmoid'}
# model.best_estimator_ :  <keras.wrappers.scikit_learn.KerasClassifier object at 0x000002C00B332B80>
# model.best_score_ :  0.9159999887148539
# model.score :  <bound method BaseSearchCV.score of RandomizedSearchCV(cv=3,
#                    estimator=<keras.wrappers.scikit_learn.KerasClassifier object at 0x000002C0737E7D90>,
#                    n_iter=1,
